...
public class ModFoods {
    ...
    public static final FoodProperties ENCHANTED_ROSEGOLD_APPLE = (new FoodProperties.Builder()).nutrition(6).saturationModifier(1.6F)
    ...
    public static final FoodProperties ROSEGOLD_APPLE = (new FoodProperties.Builder()).nutrition(6).saturationModifier(1.6F)
            .effect(new MobEffectInstance(MobEffects.REGENERATION, 400, 1), 1.0F)
            .effect(new MobEffectInstance(MobEffects.ABSORPTION, 2400, 1), 1.0F).build();
    public static final FoodProperties ROSEGOLD_CARROT = (new FoodProperties.Builder()).nutrition(9).saturationModifier(1.6F).build();
}